...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<activerecord>.freeze, ["< 4.3", ">= 3.1"])
      s.add_runtime_dependency(%q<activesupport>.freeze, ["< 4.3", ">= 3.1"])
      s.add_development_dependency(%q<rspec>.freeze, ["~> 2.0"])
      s.add_development_dependency(%q<pg>.freeze, ["~> 0"])
      s.add_development_dependency(%q<mysql2>.freeze, ["~> 0"])
      s.add_development_dependency(%q<sqlite3>.freeze, ["~> 0"])
    else
      s.add_dependency(%q<activerecord>.freeze, ["< 4.3", ">= 3.1"])
      s.add_dependency(%q<activesupport>.freeze, ["< 4.3", ">= 3.1"])
